...
如果只能写成“趋势来了”“值得关注”“行业信号”，直接不入池，不进入推荐选题。

如果只能写成“某产品新增/废弃了一个功能”“某 CLI 支持了一个命令”“某 SDK 有 breaking change”，默认不进入候选池。只有当它能继续追出迁移成本、账单风险、平台绑定、合规风险、用户反弹或普通技术人的真实选择题，并达到主文标准时，才进入推荐。

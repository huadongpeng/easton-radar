...
- 给 GPT 编辑应用：选题结论、为什么值得选、为什么暂缓、事实、证据、基础概念、读者关系、逻辑闭环、可写方向、缺口、不能写成结论的点。
...
- deep_dive 必须能回答：这是什么、和读者有什么关系、事实是否清楚、证据是否可靠、逻辑能否闭环、还缺什么材料。
- 宁可少选，也不要把普通信息包装成报告。高分候选必须能直接变成 GPT 写作前的原始素材包。
